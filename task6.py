...
def get_largest_perimiter(L):
  ...
  if (hugest == -1): return "ТРЕОГОЛЬНИКОВ НЕТУ ААААА!"
  return ("Периметр наибольшего треугольника: " + str(hugest) + "\nА вот его стороны\nПозиции: " + str(pos_a) + " " + str (pos_b) + " "  + str(pos_c) 
          + "\nДлины каждой стороны: " + str(dlin_a) + " " + str (dlin_b) + " "  + str(dlin_c))
